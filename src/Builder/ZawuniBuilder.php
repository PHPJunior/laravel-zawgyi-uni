...
namespace PhpJunior\Zawuni\Builder;
...
class ZawuniBuilder
{
    ...
    public function text($string)
    {
        if (self::isEnglish($string)) {
            ...
            if ($this->font == 'zawgyi') {
                if (self::isZawgyi($string)) {
                    return '<span class="' . $this->font . '">' . $string . '</span>';
                } else {
                    return '<span class="' . $this->font . '">' . self::uni2zg($string) . '</span>';
                }
            } else {
                if (self::isZawgyi($string)) {
                    return '<span class="' . $this->font . '">' . self::zg2uni($string) . '</span>';
                } else {
                    return '<span class="' . $this->font . '">' . $string . '</span>';
                }
            }
     ...
     * @return bool
     */
    public function isZawgyi($string)
    {
        $pattern = '/u1031| ေ[က-အ]ှ|[က-အ]း/u';
        return self::check($string, $pattern);
    }
     ...
     * @return bool
     */
    private function check($string, $pattern)
    {
     ...
     * @return string
     */
    public function uni2zg($unicode)
    {
     ...
     * @param $zawgyi
     * @return string
     * @internal param string $unicode
     */
    public function zg2uni($zawgyi)
    {
     ...
     * @return string
     */
    protected function replaceWithRule($rule, $output)
    {
